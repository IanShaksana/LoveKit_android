...
public class Frag_test19 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pertanyaan.setText(getResources().getString(R.string.pertanyaan19));

        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                newBundle.putInt("19",1);
                open_frag(new Frag_test20(), newBundle);
            }
        });
