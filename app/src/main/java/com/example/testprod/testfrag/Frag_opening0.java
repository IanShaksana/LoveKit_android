...
public class Frag_opening0 extends Fragment {
    @Nullable
    String state;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.opening0, container, false);
        ...
        Picasso.get().load(R.drawable.visual3a).centerInside().fit().into(img);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getFragmentManager()
                        ...
                        .replace(R.id.main_fragment, new Frag_opening1())
                        .addToBackStack(null)
                        .commit();
            }
        });
