...
public class Frag_test18 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pertanyaan.setText(getResources().getString(R.string.pertanyaan18));

        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                newBundle.putInt("18",1);
                open_frag(new Frag_test19(), newBundle);
            }
        });
