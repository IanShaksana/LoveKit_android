...
public class Frag_test5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pertanyaan.setText(getResources().getString(R.string.pertanyaan5));

        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                newBundle.putInt("5",1);
                open_frag(new Frag_test6(), newBundle);
            }
        });
