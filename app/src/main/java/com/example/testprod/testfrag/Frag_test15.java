...
public class Frag_test15 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pertanyaan.setText(getResources().getString(R.string.pertanyaan15));

        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                newBundle.putInt("15",1);
                open_frag(new Frag_test16(), newBundle);
            }
        });
